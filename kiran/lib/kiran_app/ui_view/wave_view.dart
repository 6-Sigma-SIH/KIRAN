          ...
          children: <Widget>[
            ClipPath(
              child: Container(
                decoration: BoxDecoration(
                  color: KiranAppTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      ...
                      KiranAppTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      KiranAppTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: KiranAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: KiranAppTheme.white.withOpacity(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/kiran_app/bottle.png"),
                ),
              ],
            )
          ],
